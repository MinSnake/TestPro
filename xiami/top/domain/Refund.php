...
class Refund
{
	 ...
	 **/
	public $refundRemindTimeout;
	
	/** 
	 * 退款版本号（时间戳）
	 **/
	public $refundVersion;
	 ...
	 * 分账给卖家的钱
	 **/
	public $splitSellerFee;
	
	/** 
	 * 分账给淘宝的钱
	 **/
	public $splitTaobaoFee;
