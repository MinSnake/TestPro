 ...
 * @return mixed
 */
function this_monday($timestamp, $is_return_timestamp = true)
{
 ...
 * @return mixed
 */
function this_sunday($timestamp, $is_return_timestamp = true)
{
...
echo '本周星期一：'.this_monday(time(),false).''; 
echo '本周星期天：'.this_sunday(time(),false).''; 
